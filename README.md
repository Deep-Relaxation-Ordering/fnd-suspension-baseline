...
the current branch: `121 passed, 0 skipped` (`92 passed` at the
...
| 12 | `r_material` / `r_hydro` split | in progress — [schema/parser note](lab_notes/2026-04-29-phase12-radius-schema-parser.md), [physics-propagation note](lab_notes/2026-04-29-phase12-physics-propagation.md) |
